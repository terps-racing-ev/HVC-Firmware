...
#define CHECK_CURR_SENSE_FLOATING 1
#define CHECK_BMB_ERRORS 1
#define CHECK_BMS_CAN_ERRORS 0
#define CHECK_LV_CAN_ERRORS 0

#define MAX_CYCLES_WITHOUT_CHARGE_REQUEST 10
